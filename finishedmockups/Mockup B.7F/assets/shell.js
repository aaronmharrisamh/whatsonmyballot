...
function notes(){open('B.7F · Recommendations, clearly.','<h3>Suggestions leave the oval empty.</h3><p>An animated down arrow points to a recommended option. OR sits above optional choices. Your own choice adds a smaller filled oval with a clear gap. The arrow or OR remains visible.</p><p>Only Recommended starts on and is shared with Ballot Viewer. Turning the switch off says Showing All. Hidden choices stay saved.</p><p>Faded opinion or magnifier buttons mean that item has no content for that control. A scale with an asterisk opens a nonrecommended choice’s opinion.</p><p>The wheel zooms with Snap off and scrolls with Snap on. Zoom stays between both-sheet fit and section width. Turning Snap on fits the section nearest the center. Section navigation fits the section you choose. All shows Front and Back together and turns Snap off. Dark Back and Next controls appear inside the active snapped section, with white zoom controls outside it. Back to Start is hidden for this iteration.</p><p>My guide lists only the admin recommendations and their opinions. Practice choices never change it. On a phone, the full-width section row stays beneath the app header and jumps instantly. Desktop keeps two columns. The generated recommendation PDF has Front and Back pages; Print my Guide includes full opinions in flowing columns. Output buttons are at the top and bottom.</p><p>District, Menu, Admin, and local draft recovery remain available.</p><p><a href="../../sharedrefs/mockup-b.7f/README.md" target="_blank" rel="noopener noreferrer">B.7F review guide</a></p><p>'+h(APP_VERSION_LABEL)+' · Fictional UI demo</p>');}
