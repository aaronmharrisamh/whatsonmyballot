...
function notes(){open('B.7 · Recommendations, clearly.','<h3>Suggestions leave the oval empty.</h3><p>An animated down arrow points to a recommended option. OR sits above optional choices. Your own choice fills the oval.</p><p>Only Recommendations starts on and is shared with Ballot Viewer. Show all choices reveals one section until you move to another. Hidden choices stay saved.</p><p>Faded opinion buttons mean no note was added. A scale with an asterisk opens a nonrecommended choice’s opinion.</p><p>The wheel zooms with Snap off and scrolls with Snap on. Zoom stays between whole-page fit and selected-section width. Back to Start keeps personal choices.</p><p>District, Menu, Admin, and local draft recovery remain available.</p><p><a href="../../sharedrefs/mockup-b.7/README.md" target="_blank" rel="noopener noreferrer">B.7 review guide</a></p><p>'+h(APP_VERSION_LABEL)+' · Fictional UI demo</p>');}
