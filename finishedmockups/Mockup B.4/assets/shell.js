...
function notes(){open('B.4 · A clearer guide','<h3>Your choices and the guide stay distinct.</h3><p>Phone view and one readable section are the defaults. Soft blue controls open inline opinions or more information. A filled circle is your choice; faint THIS and OR symbols belong to the editor’s guide.</p><p>Show guide marks hides or shows the guide highlights and automatic opinions. Admin has a fictional layout example plus local editing, save, cancel, restore, JSON import and export.</p><p>The progress line follows relative section size, with checks for sections that have saved choices. The larger bottom map opens Ballot View.</p><p>The inset viewer keeps its lime focus. Use its right-hand slider, pinch and pan, or Prev and Next. Section starts unchecked for a 75% width fit; check it for full width.</p><p><a href="../../sharedrefs/mockup-b.4/README.md" target="_blank" rel="noopener noreferrer">B.4 review guide</a></p><p>'+h(APP_VERSION_LABEL)+' · Historical November 2024 sample</p>');}
