...
function notes(){open('B.7C · Recommendations, clearly.','<h3>Suggestions leave the oval empty.</h3><p>An animated down arrow points to a recommended option. OR sits above optional choices. Your own choice adds a smaller filled oval with a clear gap. The arrow or OR remains visible.</p><p>Only Recommended starts on and is shared with Ballot Viewer. Turning the switch off says Showing All. Show all choices reveals one section until you move to another. Hidden choices stay saved.</p><p>Faded opinion or magnifier buttons mean that item has no content for that control. A scale with an asterisk opens a nonrecommended choice’s opinion.</p><p>The wheel zooms with Snap off and scrolls with Snap on. Zoom stays between whole-page fit and selected-section width. Snap and section navigation fit the selected section. The floating All button shows the page and turns Snap off. Back to Start is hidden for this iteration.</p><p>District, Menu, Admin, and local draft recovery remain available.</p><p><a href="../../sharedrefs/mockup-b.7c/README.md" target="_blank" rel="noopener noreferrer">B.7C review guide</a></p><p>'+h(APP_VERSION_LABEL)+' · Fictional UI demo</p>');}
