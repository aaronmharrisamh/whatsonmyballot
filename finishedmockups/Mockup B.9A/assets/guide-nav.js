...
export function mountGuideNav(scrollRoot, guideRoot, fixedNav = null) {
  const nav = fixedNav || guideRoot?.querySelector('.b-guide-jumps');
  ...
  function measure() {
    ...
    const offset = fixedNav ? 10 : nav.getBoundingClientRect().height + 10;
  ...
  function onClick(event) {
    ...
    scrollRoot.scrollTo({ top: entry.target, behavior: 'instant' });
    schedule();
  }
