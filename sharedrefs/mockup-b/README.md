...
See the [recorded B1 checks](VERIFICATION.md). The public ZIP includes both A and B, all shared references, and the root preview helper. It excludes local research, tools, and agent instructions.
