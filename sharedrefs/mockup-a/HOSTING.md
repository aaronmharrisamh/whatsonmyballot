...
Use the public repository files directly for preview and deployment. The root `release-manifest.json` records their version, sizes, and SHA-256 hashes without creating an archive or duplicate project copy. Ignored research, tools, local settings, agent instructions, and withheld mockups stay local.
