...
For a copied folder or extracted ZIP, open a terminal at the public project root, which contains `preview.mjs`, `sharedrefs/`, and `finishedmockups/`. With Node installed, run:
