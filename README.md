...
A static historical-ballot demo with A1–A5, B1, and the new B.1 section-focused virtual ballot, local Admin editing, and a mobile/desktop review shell.
...
[version.js](version.js) is the single app-version source, currently `0.1.2`. It supplies the landing page, preview footer, design notes, Help, and Admin. App versions are separate from the content schema and saved-content revisions.
