...
A static ballot interface demo with A1–A5 and B1 through B.5. The new B.5 has a populated fictional guide, oval marks, nearby-section chips, and a floating ballot viewer with optional Snap.
...
[version.js](version.js) is the single app-version source, currently `0.1.6`. It supplies the landing page, preview footer, design notes, Help, and Admin. App versions are separate from the content schema and saved-content revisions.

B.5 uses an isolated fictional dataset with neutral filler and random sample marks. The earlier historical sample is **Akron Township, Precinct 1AF, November 5, 2024**. Lake Orion remains the preferred later replacement. Candidate profiles are labeled examples. The [two-page sample PDF](sharedrefs/ballots/2024-11-05-akron-1af.pdf) and [client review guide](sharedrefs/mockup-a/REVIEW.md) are included.
