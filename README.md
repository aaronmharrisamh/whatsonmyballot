...
A static historical-ballot demo with A1–A5, local Admin editing, and a mobile/desktop review shell.
...
[version.js](version.js) is the single app-version source, initially `0.1.0`. It supplies the landing page, preview footer, design notes, Help, and Admin. App versions are separate from the content schema and saved-content revisions.
...
Read the [handoff](sharedrefs/mockup-a/README.md), [content guide](sharedrefs/mockup-a/CONTENT.md), [hosting guide](sharedrefs/mockup-a/HOSTING.md), and [verification notes](sharedrefs/mockup-a/VERIFICATION.md).
